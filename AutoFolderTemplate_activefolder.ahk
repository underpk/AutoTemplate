...
WinGetActiveTitle, ProjectName

; Set Source Folder Here
source = C:\Source

currentpath := Explorer_GetPath()
FileCopyDir, %Source%, %currentpath%, 1
FormatTime, TimeString,, ddMMyyyy
FileCopy, %Source%\template.ai, %currentpath%\01_%TimeString%_%ProjectName%.ai
FileDelete, %currentpath%\template.ai
return
/*
